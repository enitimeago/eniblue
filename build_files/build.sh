...
dnf5 install -y avahi-devel avahi-glib-devel boost-devel cli11-devel eigen3-devel glib2-devel glib2-devel glslang-devel gstreamer1-plugins-base-devel gstreamer1-devel libnotify-devel pipewire-devel systemd-devel libva-devel libXrandr-devel ninja-build json-devel openxr-devel patch systemd-devel
