...
A custom Fedora Atomic image, optimized for my VR gaming and development workflows.

Intended for personal use, packages may change without notice.

I provide no guarantees for stability or being up-to-date, as this is purely experimental.
...
Pre-built ISOs are not available.

First install Bazzite, then rebase with:

```sh
sudo bootc switch ghcr.io/enitimeago/eniblue
```
...
The below is from the original Universal Blue template readme:
